...
const Hostel = ({ _id, visitPurposeDetails }) => {
  ...
  const getTotalPrice = () => {
    ...
    const pricePerDay = visitPurposeDetails?.price - discount;
              ...
              <div className="flex items-center justify-center space-x-2">
                {isSubscriptionAvailed ? (
                  <>
                    ...
                    <span>Cancel Hostel Booking</span>
                  </>
                ) : (
                  <>
                    <svg
                    ...
                    <span>Activate Hostel Stay</span>
                  </>
                )}
              </div>
            </button>
        ...
        >
          <div className="flex flex-col items-center space-y-4">
            ...
            <h2 className="text-xl font-semibold" style={{ color: "#123524" }}>
              No Active Hostel Subscription
            </h2>
            <p className="text-sm" style={{ color: "#85A947" }}>
              This pet doesn't have an active subscription for hostel services
            </p>
          </div>
        </div>
      )}
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-4 pr-12 py-4 rounded-xl transition-all duration-300 focus:outline-none focus:ring-0"
                style={{
          ...
          {!isSubscriptionAvailed ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="text-xs" style={{ color: "#85A947" }}>
                  Maximum discount per day: ₹{visitPurposeDetails?.price}
                </div>
              </div>
            </div>
          ) : (
            ...
            >
              ...
              <p className="text-sm" style={{ color: "#85A947" }}>
                This hostel stay is covered by your active subscription
              </p>
            </div>
          )}
