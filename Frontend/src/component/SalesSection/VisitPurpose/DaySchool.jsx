...
const Hostel = ({ _id, visitPurposeDetails }) => {
  ...
  const initializeRazorpay = (
    ...
    const customData = {
      businessName: "Pet Day School Service",
  ...
  const handlePaymentSuccess = (updatedData, response) => {
    ...
    const onVerifySuccess = (data) => {
      ...
      dispatch(addDaySchoolVisit(daySchoolData));
  ...
  //       <div className="mt-3 max-w-full mx-auto p-6 rounded-2xl">
  //         <h2 className="text-xl font-semibold text-gray-800 text-center mb-4">
  //           The pet has no active subscription for day school
  //         </h2>
  //       </div>
  //     )}
        ...
        >
          ...
          {!isSubscriptionAvailed ? (
            ...
            >
              ...
              <p className="text-sm" style={{ color: "#85A947" }}>
                This service is covered by your active subscription
              </p>
            </div>
          )}
