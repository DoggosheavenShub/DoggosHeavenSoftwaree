              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl shadow-lg border border-[#85A947] border-opacity-30">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 sm:pl-12 pr-3 py-2 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#85A947] bg-[#EFE3C2] bg-opacity-30 text-sm sm:text-base transition-all ${errors.fullName ? 'border-red-500 focus:ring-red-500' : 'border-gray-300'
                          }`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full pl-10 sm:pl-12 pr-3 py-2 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#85A947] bg-[#EFE3C2] bg-opacity-30 text-sm sm:text-base transition-all ${errors.email ? 'border-red-500 focus:ring-red-500' : 'border-gray-300'
                          }`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-2 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#85A947] bg-[#EFE3C2] bg-opacity-30 text-sm sm:text-base transition-all ${errors.password ? 'border-red-500 focus:ring-red-500' : 'border-gray-300'
                          }`}
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className={`w-full px-4 py-2 sm:py-3 text-sm sm:text-base font-semibold text-white rounded-lg transition-all duration-300 shadow-md flex items-center justify-center space-x-2 ${loading
